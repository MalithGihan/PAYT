  ...
  return (
    <div className='w-full'>
        ...
        <form onSubmit={handleSubmit}>
            ...
            <h5 className='text-center pt-4 font-Poppins text-[14px]'>Not have an account ? <span className='text-[#2190ff] pl-1 cursor-pointer' onClick={() => setRoute("Sign-Up")}>Sign up</span></h5>
        </form>
        <br />
    </div>
  )
