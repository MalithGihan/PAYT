...
const ComplaintsComponent = () => {
  ...
  return (
    <div className="p-5 bg-green-100 dark:bg-gray-800 rounded-lg shadow-lg">
      ...
      <p className="text-gray-700 dark:text-gray-300 my-5">
        Here you can view and submit complaints related to the system.
      </p>

      <div className="flex space-x-4 mb-4">
        <button
          className={`px-4 py-2 rounded-md focus:outline-none ${isCreating ? 'bg-green-600 text-white' : 'bg-white text-black'
            }`}
